...
user_pref("app.update.lastUpdateTime.addon-background-update-timer", 1776082342);
user_pref("app.update.lastUpdateTime.browser-cleanup-thumbnails", 1776082342);
user_pref("app.update.lastUpdateTime.region-update-timer", 1776082342);
user_pref("app.update.lastUpdateTime.services-settings-poll-changes", 1776082342);
user_pref("app.update.lastUpdateTime.xpi-signature-verification", 1776082342);
user_pref("browser.bookmarks.restore_default_bookmarks", false);
user_pref("browser.contentblocking.category", "standard");
user_pref("browser.download.viewableInternally.typeWasRegistered.avif", true);
user_pref("browser.download.viewableInternally.typeWasRegistered.webp", true);
user_pref("browser.migration.version", 150);
user_pref("browser.newtabpage.activity-stream.impressionId", "{65a71b43-ac20-491a-96ff-a30b3ad14404}");
...
user_pref("browser.startup.lastColdStartupCheck", 1776082312);
...
user_pref("captchadetection.lastSubmission", 1776074);
...
user_pref("extensions.formautofill.creditCards.reauth.optout", "MDIEEPgAAAAAAAAAAAAAAAAAAAEwFAYIKoZIhvcNAwcECBh5CSXFG4SuBAjKrHRc/akxyw==");
...
user_pref("extensions.webextensions.uuids", "{\"formautofill@mozilla.org\":\"6da5c8ee-d74f-4d67-be34-c0219be1b2c5\",\"pictureinpicture@mozilla.org\":\"6a01ab3b-74b5-47df-824f-94a99cd9fb9e\",\"screenshots@mozilla.org\":\"29864e50-ea72-4d42-a106-b3ab4c29b455\",\"webcompat@mozilla.org\":\"cab989d2-b39f-4561-b809-b31a2c35dcc8\",\"firefox-compact-dark@mozilla.org\":\"cb2f8c23-0902-4d11-9cec-ec7c529d7d3e\",\"addons-search-detection@mozilla.com\":\"9c399296-8320-49c0-9222-a1a12e3436c7\",\"uBlock0@raymondhill.net\":\"0f065258-acde-45ab-84da-ca8dcaa3c084\"}");
...
user_pref("media.gmp-manager.lastCheck", 1776082336);
user_pref("media.gmp-manager.lastEmptyCheck", 1776082336);
...
user_pref("toolkit.startup.last_success", 1776082310);
